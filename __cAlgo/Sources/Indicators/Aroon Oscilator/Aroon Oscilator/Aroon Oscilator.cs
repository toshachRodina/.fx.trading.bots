...
namespace cAlgo.Indicators
{
    ...
    public class AroonOscilator : Indicator
    {
        ...
        [Output("Positive", PlotType = PlotType.Histogram, LineColor = "FF00BF00", LineStyle = LineStyle.Solid, Thickness = 5)]
        public IndicatorDataSeries Positive { get; set; }

        [Output("Negative", PlotType = PlotType.Histogram, LineColor = "FFFF6666", LineStyle = LineStyle.Solid, Thickness = 5)]
