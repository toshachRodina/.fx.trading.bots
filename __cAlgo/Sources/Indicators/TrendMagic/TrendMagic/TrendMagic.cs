...
namespace cAlgo.Indicators
{
    ...
    public class TrendMagic : Indicator
    {
        ...
        [Output("Main Line", LineColor = "79FFC000", PlotType = PlotType.Line, Thickness = 1 )]
        public IndicatorDataSeries MTrend { get; set; }

        [Output("Down Trend", LineColor = "FFFF999A", PlotType = PlotType.Points, Thickness = 4)]
        public IndicatorDataSeries DownTrend { get; set; }

        [Output("Up Trend", LineColor = "FF02AFF1", PlotType = PlotType.Points, Thickness = 4)]
